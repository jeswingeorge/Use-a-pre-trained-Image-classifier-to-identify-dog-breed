...
#### Project Goal
Project done as part of Udacity course - [AI Programming with Python Nanodegree](https://www.udacity.com/course/ai-programming-python-nanodegree--nd089).

Improving your programming skills using Python. In this project, you will use a created image classifier to identify dog breeds. Focus is on Python and not on the actual classifier.
...
__Note, you DO NOT need to create the classifier. It will be provided to you. You will need to apply the Python tools you just learned to USE the classifier__.
...
3. Determine which CNN model architecture (ResNet, AlexNet, or VGG), "__best__" achieve objectives 1 and 2.
4. Consider the time resources required to best achieve objectives 1 and 2, and determine if an alternative solution would have given a "_good enough_" result, given the amount of time each of the algorithms takes to run.
...
__If you feel that you need more guidance, please refer to the files ending `with_hints.py`. In the workspace, you will find a hint file for each of the tasks.__
...
- Function docstrings contain __input parameters and return values__, which were left to provide guidance. You are welcome to program these functions differently.
- In __6. Timing Code__ to __19. Printing Results__ we will provide additional guidance for programming the undefined functions and completing the `check_images.py` program. This information has been provided to help you through the process.
- You can use the functions within the program [print_functions_for_lab_checks.py](https://github.com/udacity/AIPND-revision/blob/master/intropyproject-classify-pet-images/print_functions_for_lab_checks.py) to check your code for sections __8. Command Line Arguments__ through __17. Calculating Results__.
